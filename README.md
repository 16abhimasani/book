...
<!-- SNAPSHOT:START -->
_As of 2026-06-18T19:43:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 27 alert(s)/24h · recent: MOVE TSM +6.6% (460.60) — watchlist mover · MOVE SPCX -5.4% (181.50) — watchlist mover · MOVE ASTS -7.0% (79.42) — watchlist mover**
<!-- SNAPSHOT:END -->
