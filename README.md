...
<!-- SNAPSHOT:START -->
_As of 2026-06-30T16:48:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 21 alert(s)/24h · recent: MOVE AMBA +24.5% (83.44) — watchlist mover · MOVE RKLB +5.6% (103.45) — watchlist mover · MOVE ALAB +7.0% (487.72) — watchlist mover**
<!-- SNAPSHOT:END -->
