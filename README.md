...
<!-- SNAPSHOT:START -->
_As of 2026-06-17T18:44:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 12 alert(s)/24h · recent: MOVE SPCX -6.7% (188.26) — watchlist mover · MOVE DELL +5.1% (424.69) — watchlist mover · MOVE ASTS +7.0% (88.04) — watchlist mover**
<!-- SNAPSHOT:END -->
