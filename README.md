...
<!-- SNAPSHOT:START -->
_As of 2026-06-17T00:42:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._

**Invested $4,585.00 · Current $4,767.94 · Profit +$182.94 (+4.0%)**

Settled cash $1,334.15 · 1/6 slots · open risk to stops $0.00 (0.0%)

| Position | Qty | Entry | Stop | Mark | P&L | Theme |
|---|--:|--:|--:|--:|--:|---|
| DAL | 17 | 82.67 | 82.67 (locked) | 82.98 | +0.4% | oil-collapse-beneficiary |
...
**Measurement gate (POLICY §6a):** 5 closed / 1 open · expectancy 0.76R · capital-add not eligible (needs ≥10 closed / >+0.25R / 0 breaches / ≥4wk). Per lane: L1 0.88R (4 closed) · L2 0.31R (1 closed).

**Lane-2 regime gate:** OFF (confirmed 2-day; QQQ 729.78 vs 20d MA 724.44, as of 2026-06-16).

**Watcher: idle (off-hours), last scan 45m ago · 72 alert(s)/24h · recent: MOVE SPCX +9.0% (209.81) — watchlist mover · MOVE SPCX +7.3% (206.61) — watchlist mover · MOVE SPCX +5.2% (202.42) — watchlist mover**
<!-- SNAPSHOT:END -->
