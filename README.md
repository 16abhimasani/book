...
<!-- SNAPSHOT:START -->
_As of 2026-06-30T17:46:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 18 alert(s)/24h · recent: MOVE ALAB +7.0% (487.72) — watchlist mover · MOVE AMBA +26.4% (84.72) — watchlist mover · MOVE CRDO +9.5% (269.05) — watchlist mover**
<!-- SNAPSHOT:END -->
