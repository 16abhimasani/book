...
<!-- SNAPSHOT:START -->
_As of 2026-06-30T14:44:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 14 alert(s)/24h · recent: MOVE SPCX +8.0% (165.42) — watchlist mover · MOVE SNDK +5.8% (2168.81) — watchlist mover · MOVE SNDK +7.4% (2201.37) — watchlist mover**
<!-- SNAPSHOT:END -->
