...
<!-- SNAPSHOT:START -->
_As of 2026-06-18T12:43:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 14 alert(s)/24h · recent: MOVE DELL +5.1% (424.60) — watchlist mover · MOVE ASTS +5.3% (86.60) — watchlist mover · MOVE SPCX -5.2% (191.31) — watchlist mover**
<!-- SNAPSHOT:END -->
