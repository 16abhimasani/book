...
<!-- SNAPSHOT:START -->
_As of 2026-06-16T15:41:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._

**Invested $4,585.00 · Current $4,798.98 · Profit +$213.98 (+4.7%)**

Settled cash $1,334.15 · 3/6 slots · open risk to stops $0.00 (0.0%)

| Position | Qty | Entry | Stop | Mark | P&L | Theme |
|---|--:|--:|--:|--:|--:|---|
| MU | 1 | 941.50 | 1020.50 (locked) | 1036.39 | +10.1% | ai-capex |
| DAL | 17 | 82.67 | 82.67 (locked) | 83.77 | +1.3% | oil-collapse-beneficiary |
| AMD | 1 | 514.99 | 514.99 (BE) | 519.87 | +0.9% | ai-capex |
...
**Measurement gate (POLICY §6a):** 3 closed / 3 open · expectancy 0.93R · capital-add not eligible (needs ≥10 closed / >+0.25R / 0 breaches / ≥4wk). Per lane: L1 1.24R (2 closed) · L2 0.31R (1 closed).

**Lane-2 regime gate:** OFF (confirmed 2-day; QQQ 743.84 vs 20d MA 723.25, as of 2026-06-15) — raw ON pending one more close.

**Watcher: running · 63 alert(s)/24h · recent: MOVE-HELD AMD -5.1% (519.49) · STOP-ADJACENT AMD 519.49 vs stop 514.99 (0.9% away) · MOVE SPCX +9.3% (210.49) — watchlist mover**
<!-- SNAPSHOT:END -->
