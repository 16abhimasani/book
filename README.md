...
<!-- SNAPSHOT:START -->
_As of 2026-06-30T13:45:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 22 alert(s)/24h · recent: MOVE ASTS +19.8% (85.59) — watchlist mover · MOVE SPCX +8.0% (165.42) — watchlist mover · MOVE SNDK +5.8% (2168.81) — watchlist mover**
<!-- SNAPSHOT:END -->
