...
<!-- SNAPSHOT:START -->
_As of 2026-06-30T15:44:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._
...
**Watcher: running · 14 alert(s)/24h · recent: MOVE SNDK +7.4% (2201.37) — watchlist mover · MOVE SNDK +5.5% (2163.01) — watchlist mover · MOVE SNDK +7.1% (2196.91) — watchlist mover**
<!-- SNAPSHOT:END -->
