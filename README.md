...
<!-- SNAPSHOT:START -->
_As of 2026-06-16T16:43:00Z — auto-generated by the trading loop (`bun run snapshot`). Source of truth is Robinhood; this is the committed mirror._

**Invested $4,585.00 · Current $4,789.60 · Profit +$204.60 (+4.5%)**

Settled cash $1,334.15 · 2/6 slots · open risk to stops $0.00 (0.0%)

| Position | Qty | Entry | Stop | Mark | P&L | Theme |
|---|--:|--:|--:|--:|--:|---|
| DAL | 17 | 82.67 | 82.67 (locked) | 83.95 | +1.5% | oil-collapse-beneficiary |
| AMD | 1 | 514.99 | 514.99 (BE) | 520.39 | +1.0% | ai-capex |
...
**Measurement gate (POLICY §6a):** 4 closed / 2 open · expectancy 0.95R · capital-add not eligible (needs ≥10 closed / >+0.25R / 0 breaches / ≥4wk). Per lane: L1 1.17R (3 closed) · L2 0.31R (1 closed).

**Lane-2 regime gate:** OFF (confirmed 2-day; QQQ 743.84 vs 20d MA 723.25, as of 2026-06-15) — raw ON pending one more close.

**Watcher: running · 68 alert(s)/24h · recent: STOP-ADJACENT MU 1050.07 vs stop 1020.50 (2.8% away) · MOVE SPCX +11.0% (213.69) — watchlist mover · MOVE SPCX +12.8% (217.06) — watchlist mover**
<!-- SNAPSHOT:END -->
